    ...
    <section id='contact' className='section'>
      <div className="container">
        <div className="">
            ...
            <p className="">
                Reach out to me for any inquiries or collaborations. I am always open to discussing new projects, creative ideas, or opportunities to be part of your vision.
            </p>
        ...
        <form action="" className="" method='POST'>
            <div className="">
                <div className="">
                    ...
                    <input id='name' type="text" name='name' autoComplete='name' required className="" />
                </div>
            </div>
        </form>
      </div>
