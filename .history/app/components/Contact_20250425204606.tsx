    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w[12ch]">Contact Me for your next project</h2>

          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Reach out to me for any inquiries or collaborations. I am always
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a key={key} href={href} target="blank" className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80">
                {icon}
              </a>
            ))}
          </div>
        ...
        <form action="" className="xl:pl-10 2xl:pl-20" method="POST">
          ...
          <div className="mb-4">
            ...
            <textarea name="message" id="message" required  placeholder="Hi!" className="text-field resize-y min-h-32 max-h-80">

            </textarea>
          </div>

          <button type="submit" className="btn btn-primary [&]:max-w-full w-full just">
            Submit
          </button>
        </form>
      </div>
