...
const socialLinks = [
  ...
  {
    href: "https://www.linkedin.com/in/ùsman-umar-37777223a",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://x.com/UsmanUm58956112_",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.instagram.com/_sturdyman/",
    icon: (
      <svg
        width="25"
        height="24"
