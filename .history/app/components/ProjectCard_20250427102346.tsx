    ...
    >
      ...
      <figure className="img-box aspect-square rounded-lg mb-4">
        ...
        <div className="w-11 h-11">
          <span data-tooltip-id="tooltip" data-tooltip-content="checkout live" className="material-symbols-rounded absolute top-6 right-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
