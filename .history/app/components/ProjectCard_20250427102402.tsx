    ...
    >
      ...
      <figure className="img-box aspect-square rounded-lg mb-4">
        ...
        <div className="w-11 h-11">
          <span data-tooltip-id="my-tooltip" data-tooltip-content="checkout live" className="material-symbols-rounded absolute top-6 right-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            <Tooltip id="my-tooltip" place="top" className="group-hover:opacity-100 opacity-0 text-white text-sm rounded-lg px-2 py-1 shadow-md" />
            open_in_new
          </span>
        </div>
      </figure>
