    ...
    >
      <figure className="img-box aspect-square rounded-lg mb-4 relative">
        ...
        <span
          ...
          data-tooltip-content="Check out live"
          className="material-symbols-rounded absolute top-6 right-6 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer"
        >
          open_in_new
        </span>
      </figure>

      {/* Tooltip component should be rendered once outside the trigger */}
      <Tooltip id="tooltip" place="top" className="text-white text-sm rounded-lg px-2 py-1 shadow-md" />
