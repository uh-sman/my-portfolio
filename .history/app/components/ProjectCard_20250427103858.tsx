...
const MyTooltip = ({ tooltipContent }: MyTooltipProps) => {
  return (
    <span className="bg-zinc-800 absolute -top-3 right-2 p-2 rounded-lg text-sm text-zinc-50 shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:scale-105">
