      ...
      <figure className="img-box aspect-square rounded-lg mb-4">
        ...
        <div className="w-11 h-11">
          ...
          <Tooltip
            id="my-tooltip"
            place="top"
            className="bg-zinc-600 absolute -top-6 -right-2 p-2 rounded-lg text-sm text-zinc-50 shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300  group-hover:animater-fade-in group-hover:duration-300"
          />
